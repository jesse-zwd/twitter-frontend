...
const ProfileInfo = ({ profile }) => {
  ...
  return (
    <Wrapper>
      <CoverPhoto src={coverPhoto ? coverPhoto : cover } alt="cover" />
      <Avatar className="avatar" lg src={avatar ? avatar : default_avatar} alt="profile" />
      ...
      <div className="profile-info">
        ...
        <div className="follow-following">
          <span>
            {followerCount ? `${followerCount} followers` : "No followers"}
          </span>
          <span>
            {followingCount
